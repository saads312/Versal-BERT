#
# Simulation Build Script for NoC Self-Output Stage Design
# Tests: LayerNorm(Linear(attention_output) + residual)
#

set project_name "noc_self_output_sim"
...
# Import Testbench
import_files -fileset sim_1 ${sim_dir}/noc_self_output_tb.sv
...
#####################################################
puts "INFO: Sourcing NoC constraints TCL commands for self-output layer..."
source ${xdc_dir}/noc_constraints_self_output.xdc
...
source ${project_dir}/scripts/patch_defparams_self_output.tcl
